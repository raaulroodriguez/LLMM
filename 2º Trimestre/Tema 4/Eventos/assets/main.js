...
const unClick = document.querySelector("#g1");
const robot = document.querySelector("#g2");
const invisible = document.querySelector("#g3");
const dblclick = document.querySelector("#g4");
const btn = document.querySelector("#btn");
const cursor = document.querySelector("#g6");
